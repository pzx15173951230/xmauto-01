    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        for (var i = 0; i < bannerArr.length; i++) {
          $("<a href=\"#\">\n                        <img class = 'swiper-lazy swiper-lazy-loaded' src = '../images/banner/".concat(bannerArr[i].img, "' alt=\"\"/>\n                    </a>")).appendTo("#J_homeSwiper .swiper-slide");
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        for (var i = 0; i < sideArr.length; i++) {
          var node = $("<li class = 'category-item'>\n                        <a href=\"/index.html\" class = 'title'>\n                            ".concat(sideArr[i].title, "\n                            <em class = 'iconfont-arrow-right-big'></em>\n                        </a>\n                        <div class=\"children clearfix\">\n                            \n                        </div>\n                    </li>"));
          node.appendTo("#J_navCategory #J_categoryList"); //取出其中的子节点
