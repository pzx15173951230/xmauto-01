...
define(["jquery"], function ($) {
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        for (var i = 0; i < slideArr.length; i++) {
          $("<li class = 'swiper-slide rainbow-item-3' style = 'width: 234px; margin-right: 14px;'>\n                        <a href=\"#\" target = \"_blank\">\n                            <div class = 'content'>\n                                <div class = 'thumb'>\n                                    <img width=\"160\" height=\"160\" src=\"".concat(slideArr[i].pc_img, "?thumb=1&w=200&h=200&f=webp&q=90\" alt=\"\"/>\n                                </div>\n                                <h3 class = 'title'>").concat(slideArr[i].goods_name, "</h3>\n                                <p class = 'desc'>").concat(slideArr[i].desc, "</p>\n                                <p class = 'price'>\n                                    <span>").concat(slideArr[i].seckill_Price, "</span>\u5143\n                                    <del>").concat(slideArr[i].goods_price, "\u5143</del>\n                                </p>\n                            </div>\n                        </a>\n                    </li>")).appendTo("#J_flashSaleList ul");
        }
      },
  ...
  function slideTab() {
    ...
    var iNow = 0;
    var count = Math.ceil(26 / 4) - 1; //启动定时器，让其一开始自己滚动
    ...
    function tab() {
      ...
      $("#J_flashSaleList ul").css({
        transform: "translate3d(".concat(iTarget, "px, 0px, 0px)"),
  ...
  function countDown() {
    ...
    var afterDate = new Date(); //计算倒计时时间间隔
    ...
    afterDate.setUTCMilliseconds(0); //计算倒计时总秒数
